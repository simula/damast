...
AISTestDataSpec = {
    ...
    "columns": [
        ...
        {"name": "lon", "is_optional": False, "unit": "deg", "category": DataCategory.DYNAMIC}, #, "value_range": CyclicMinMax(-180.0, 180.0)},
        {"name": "lat", "is_optional": False, "unit": "deg", "category": DataCategory.DYNAMIC}, # , "value_range": CyclicMinMax(-90.0, 90.0)},
